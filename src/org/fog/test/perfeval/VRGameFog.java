...
try {
    ...
    java.io.FileWriter writer = new java.io.FileWriter("output/results.csv");
    writer.write("Metric,Value\n");
    writer.write("SimulationStatus,Completed\n");
    writer.write("SimulationTime," + CloudSim.clock() + "\n");
    writer.write("TotalDevices," + fogDevices.size() + "\n");
    writer.write("NumberOfSensors," + sensors.size() + "\n");
    writer.write("NumberOfActuators," + actuators.size() + "\n");
    writer.write("DeploymentMode," + (CLOUD ? "Cloud" : "Edge") + "\n");
    writer.close();
    System.out.println("✅ Results exported to output/results.csv");
} catch (Exception e) {
    e.printStackTrace();
}
